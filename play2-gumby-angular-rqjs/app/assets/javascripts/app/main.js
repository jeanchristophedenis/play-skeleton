define(['jquery','angular', 'angular-resource','angular-route', 'angular-cookies', 'angular-animate', './directives'],function($, angular){
    ...
    require(['app/todo'], function(){
        angular.bootstrap(document, ['ngResource', 'ngRoute', 'ngCookies', 'ngAnimate', 'directives', 'app.services', 'todo']);
    });
